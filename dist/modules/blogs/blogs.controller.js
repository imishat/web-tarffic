...
const CreateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield blogs_service_1.BlogsServices.create(req.body);
        res.send({
            success: true,
...
const SingleController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield blogs_service_1.BlogsServices.GetSingle(id);
        res.send({
            success: true,
...
const AllController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield blogs_service_1.BlogsServices.All(options);
        res.send({
            success: true,
...
const updateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = req.body;
    try {
        const result = yield blogs_service_1.BlogsServices.update(id, data);
        res.send({
            success: true,
...
const deleteController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
    try {
        const result = yield blogs_service_1.BlogsServices.deletedata(id);
        res.send({
            success: true,
