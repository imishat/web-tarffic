...
const CreateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield web_service_1.WebServices.create(req.body);
        res.send({
            success: true,
...
const SingleController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield web_service_1.WebServices.GetSingle(id);
        res.send({
            success: true,
...
const AllController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield web_service_1.WebServices.All();
        res.send({
            success: true,
...
const updateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = req.body;
    try {
        const result = yield web_service_1.WebServices.update(id, data);
        res.send({
            success: true,
...
const deleteController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
    try {
        const result = yield web_service_1.WebServices.deletedata(id);
        res.send({
            success: true,
